...
public class GCP_INT extends Base {
    final static Logger logger = Logger.getLogger(GCP_INT.class);
    AdminPage adminPage = new AdminPage();
    SubscriberPage goToSubscriberPage = new SubscriberPage();

    @DataProvider(name = "UI_AUTOMATION_TEST_DATA_INT")
    private Object[][] UI_AUTOMATION_TEST_DATA() {
        ...
        Object[][] data;
        data = excelReader.getExcelData("int");
        return data;
    }

    @Test(enabled = true,dataProvider = "UI_AUTOMATION_TEST_DATA_INT")
    public void INT_Privacy_Test(String env, String expected, String username, String password, String ian) throws IOException, InterruptedException {
