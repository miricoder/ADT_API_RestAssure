...
//    @AfterMethod()
    public void ibpConfig() {
        ...
        FileReader ibpConf = new FileReader("src/test/resources/DynamicValueFiles/ibpConfig.json");
...
@Test(alwaysRun = false)
//@AfterMethod()
    public void camConfig_camStatus() {
        final Logger logger = Logger.getLogger(VALIDATE_ibpConfig.class);
        BasicConfigurator.configure();
                 /*
        Parsing cameraStatusList.json file saved from the WSS Response
         */
        FileReader cameraStatus = new FileReader("src/test/resources/DynamicValueFiles/cameraStatusList.json");
