...
public class PROD extends Base {
    ...
    @DataProvider(name = "UI_AUTOMATION_TEST_DATA_PROD")
    private Object[][] UI_AUTOMATION_TEST_DATA() {
        ...
        Object[][] data;
        data = excelReader.getExcelData("prod");
        return data;
    }

    @Test(enabled = true,dataProvider = "UI_AUTOMATION_TEST_DATA_PROD")
    public void PROD_Privacy_Test(String env, String expected, String username, String password, String ian) throws IOException, InterruptedException {
